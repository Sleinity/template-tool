...
} from "../models/packageRenderValues";
import { getPackageNodePositioning } from "../models/packageLayoutModel";
import { resolvePackageStrokeModel } from "../models/packageStrokeModel";
import { resolvePackageTransform } from "../models/packageTransformModel";
import { resolvePackageVectorModel } from "../models/packageVectorModel";
import type {
  ResolvedEffect,
...
function resolveVector(
  ...
  const model = node.vector
    ? resolvePackageVectorModel(node, packageValue)
    : null;
