...
import type { BackendDecisionNodeInputV1 } from "./inputContracts";
...
function primitiveOwners(node: BackendDecisionNodeInputV1): ResolvedBackendOwnerV1[] {
...
export function resolveBackendDecision(
  node: BackendDecisionNodeInputV1,
