...
import type { CoreLayoutRuntimeState } from "../runtime-routing";
import type { TemplatePackageV1 } from "../types";
import type { ResolvedProductRenderIdentityV1 } from "../../../packages/template-browser/src/runtime/renderIdentity";
export type { ResolvedProductRenderIdentityV1 } from "../../../packages/template-browser/src/runtime/renderIdentity";
