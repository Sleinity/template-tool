...
import type { PackageTransformModel } from "../../../packages/template-core/src/models/packageTransformModel";

export {
  resolvePackageTransform,
  type PackageTransformModel,
} from "../../../packages/template-core/src/models/packageTransformModel";
