...
} from "../../../packages/template-browser/src/internal/qualityIssue";
export * from "../../../packages/template-browser/src/internal/qualityIssue";
...
export interface PackageQualityReport {
  ...
  renderingHealth: {
    ...
    productRenderIdentity: import("../render/productRenderIdentity").ResolvedProductRenderIdentityV1 | null;
  };
