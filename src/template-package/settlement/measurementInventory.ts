...
export const CURRENT_MEASUREMENT_INVENTORY: MeasurementInventoryEntryV1[] = [
  ...
  { id: "MEAS-005", property: "Image intrinsic size/readiness", currentLocation: "export/pngExport.ts, Studio field editor, fidelity/browser.mjs", trigger: "HTMLImageElement.decode/load", currentConsumer: "export readiness, replacement metadata and harness", staleWorkProtection: "per-promise completion; no package/asset revision", milestone3Contract: "intrinsic-image and asset-readiness records" },
